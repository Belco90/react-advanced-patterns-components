...
describe.each(['ExampleUsingChildrenRefs'])('%s component', componentName => {
  ...
  it('should apply filters', () => {
    ...
    // select content type
    fireEvent.change(getByLabelText('Content'), { target: { value: 'image' } });
  ...
  it('should clear individual filters', () => {
    ...
    fireEvent.click(getByText('Filters')); // should be restored without open?
    expect(getByTestId('testing-form')).toHaveFormValues({
      min: null,
      max: null,
      starred: true,
